...
class MDSClient(VendorClient):
    """Fetch MDS/OneTick history.

    Placeholder: returns random values within a range for the requested
    series until a real MDS/OneTick integration is wired in.
    """
    ...
    def fetch(
        ...
        **kwargs: object,
        ...
        return fetch_demo_values("MDS", tickers, start, end)
