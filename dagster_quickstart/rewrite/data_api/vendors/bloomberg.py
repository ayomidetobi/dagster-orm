...
class BloombergClient(VendorClient):
    """Fetch Bloomberg history.

    Placeholder: returns random values within a range for the requested
    series until a real Bloomberg integration (e.g. pyeqdr) is wired in.
    """
    ...
    def fetch(
        ...
        **kwargs: object,
        ...
        return fetch_demo_values("Bloomberg", tickers, start, end)
